...
while True:
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            if lmList:    
                ...
                #print(length)
                if (length/300)*100 > 85:
                    cv2.circle(img , (z1 , z2) ,15 ,(0,0,255) , cv2.FILLED)


                if length < 50:
                    cv2.circle(img , (z1 , z2) ,15 ,(0,0,0) , cv2.FILLED)
                    cv2.circle(img , (z1 , z2) ,13 ,(255,255,255) , cv2.FILLED)
    ...
    cv2.imshow("Image(To exit the window press 'q')" , img)
    cv2.waitKey(1)